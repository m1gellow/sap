                ...
                <div>
                  ...
                  <div className="mt-4 flex flex-col gap-3 text-sm">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="border border-gray-300 text-gray-800 font-normal px-5 py-1 rounded-md">{product.weight ? `${product.weight / 1000} кг` : '8,9 кг'}</div>
                    </div>
                    <div className="flex items-center gap-4">
            ...
            <div className="mt-12 flex flex-col gap-6">
              ...
              <div className="border border-gray-200 rounded-lg bg-skyblue">
                ...
                >
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transition-transform duration-300 ${isDescriptionOpen ? '' : '-rotate-90'}`}>
              ...
              <div className="border bg-skyblue border-gray-200 rounded-lg">
                ...
                >
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transition-transform duration-300 ${isParametersOpen ? '' : '-rotate-90'}`}>
                    <path d="M6 9L12 15L18 9" stroke="#4B5563" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                {isParametersOpen && (
